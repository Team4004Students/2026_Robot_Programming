...
public class IntakeUp extends Command {
  ...
  /** Creates a new IntakeUpNew. */
  public IntakeUp(IntakePosition copyIntakePosition) {
  ...
  public void initialize() {
    intakePosition.intakeUpPosition();
  }
  ...
  public boolean isFinished() {
    if (DriverStation.isAutonomous() && intakePosition.atUpPosition()) {
      return true;
    }
