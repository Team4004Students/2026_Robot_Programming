...
public class IntakePosition extends SubsystemBase {
  ...
  public IntakePosition() {
    ...
    slot0.kP = 60.0; // A position error of 0.2 rotations results in 12 V output. (60::FOR LUTHER TO REMEMBER)
  ...
  public void intakeUpPosition() {
    intakePositionMotor.setControl(new MotionMagicVoltage(0.6716 * GEAR_RATIO));
  }

  public void intakeDownPosition() {
    intakePositionMotor.setControl(new MotionMagicVoltage(0.22 * GEAR_RATIO));
  }

  public void intakeBumpPosition() {
    intakePositionMotor.setControl(new MotionMagicVoltage(0.51 * GEAR_RATIO));
  }
